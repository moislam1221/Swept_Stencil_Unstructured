...
int main (int argc, char * argv[]) 
{
	...
	uint32_t Ndofs = 23364; // 5876; // this is for the coarse airfoil mesh condensed
	...
	linearSystem matrix;
	matrix.Ndofs = Ndofs;
	initializeAndLoadMatrixFromDirectory(matrix, "Unstructured_Mesh/Airfoil_Mesh_25k/Matrix_Data");   
	...
	uint32_t numIterations = 12 * numSweptCycles; // numSweptCycles * 10;
	...
	std::string PARENT_DIRECTORY = "Unstructured_Mesh/Airfoil_Mesh_25k/";
	...
	upperPyramidal.numSubdomains = 80; // 25
...
*/
	...
	// V2 kernel (overlapping)
	stageAdvanceJacobiPerformanceV2Overlap<<<bridge.numSubdomains, 512, bridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d,  iterationLevel_d, iterationLevelOutput_d, bridge_d, 0, numJacobiIters, Ndofs);
	tmp = evenSolutionBuffer_d; evenSolutionBuffer_d = evenSolutionBufferOutput_d; evenSolutionBufferOutput_d = tmp;
	tmp = oddSolutionBuffer_d; oddSolutionBuffer_d = oddSolutionBufferOutput_d; oddSolutionBufferOutput_d = tmp;
	tmpInt = iterationLevel_d; iterationLevel_d = iterationLevelOutput_d; iterationLevelOutput_d = tmpInt;
	...
	lowerPyramidal.numSubdomains = 90; // 22;
	...
	*/
	...
	dualBridge.numSubdomains = 130; // 35;
	...
	// V2 kernel (overlapping)
	stageAdvanceJacobiPerformanceV2Overlap<<<dualBridge.numSubdomains, 512, dualBridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d,  iterationLevel_d, iterationLevelOutput_d, dualBridge_d, 0, numJacobiIters, Ndofs);
	tmp = evenSolutionBuffer_d; evenSolutionBuffer_d = evenSolutionBufferOutput_d; evenSolutionBufferOutput_d = tmp;
	tmp = oddSolutionBuffer_d; oddSolutionBuffer_d = oddSolutionBufferOutput_d; oddSolutionBufferOutput_d = tmp;
	tmpInt = iterationLevel_d; iterationLevel_d = iterationLevelOutput_d; iterationLevelOutput_d = tmpInt;
	...
	for (int sweptIteration = 0; sweptIteration < numSweptCycles; sweptIteration++) {
		...
		// V2 kernel (overlapping)
		stageAdvanceJacobiPerformanceV2Overlap<<<bridge.numSubdomains, 512, bridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d,  iterationLevel_d, iterationLevelOutput_d, bridge_d, minJacobiIters, maxJacobiIters, Ndofs, maxJacobiShift);
		tmp = evenSolutionBuffer_d; evenSolutionBuffer_d = evenSolutionBufferOutput_d; evenSolutionBufferOutput_d = tmp;
		tmp = oddSolutionBuffer_d; oddSolutionBuffer_d = oddSolutionBufferOutput_d; oddSolutionBufferOutput_d = tmp;
		tmpInt = iterationLevel_d; iterationLevel_d = iterationLevelOutput_d; iterationLevelOutput_d = tmpInt;
		//
		...
		// V2 kernel (overlapping)
		stageAdvanceJacobiPerformanceV2Overlap<<<dualBridge.numSubdomains, 512, dualBridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d, iterationLevel_d, iterationLevelOutput_d, dualBridge_d, minJacobiIters, maxJacobiIters, Ndofs, maxJacobiShift);
		tmp = evenSolutionBuffer_d; evenSolutionBuffer_d = evenSolutionBufferOutput_d; evenSolutionBufferOutput_d = tmp;
		tmp = oddSolutionBuffer_d; oddSolutionBuffer_d = oddSolutionBufferOutput_d; oddSolutionBufferOutput_d = tmp;
		tmpInt = iterationLevel_d; iterationLevel_d = iterationLevelOutput_d; iterationLevelOutput_d = tmpInt;
		// 
