/* Swept Jacobi Functions */

/* V1 with in-place solution replacement (Stages 1, 3) */
...
/* V2 with solution in new buffers (Stages 1, 3) */
...
void determineSharedMemoryAllocationMinimal(meshPartitionForStage &partition)
{
	...
	printf("The shared memory size is %d bytes\n", sharedMemorySize);
}

// (2) Full shared version
...
// Copy solution to another buffer
__global__
...
// Assemble solution from even/odd buffers
__global__
