...
int main (int argc, char * argv[]) 
{
    // INPUTS
    uint32_t N = 128;
    uint32_t nPerSub = 16; // each subdomain is Nsub by Nsub
...
/*	
	...
	stageAdvanceJacobiPerformance<<<dualBridge.numSubdomains, 512, dualBridge.sharedMemorySize>>>(topSweptSolution_d, bottomSweptSolution_d, iterationLevel_d, dualBridge_d, numJacobiStepsIncrement, numJacobiSteps, numJacobiSteps);
...
/*	
	...
	for (int sweptIteration = 0; sweptIteration < numSweptCycles; sweptIteration++) {
		...
		stageAdvanceJacobiPerformance<<<upperPyramidal.numSubdomains, 512, upperPyramidal.sharedMemorySize>>>(topSweptSolution_d, bottomSweptSolution_d, iterationLevel_d, upperPyramidal_d, numJacobiStepsMin, numJacobiSteps, numJacobiSteps);
		...
		stageAdvanceJacobiPerformance<<<bridge.numSubdomains, 512, bridge.sharedMemorySize>>>(topSweptSolution_d, bottomSweptSolution_d, iterationLevel_d, bridge_d, numJacobiStepsMin, numJacobiSteps, numJacobiSteps);
		// cudaDeviceSynchronize();
		...
		stageAdvanceJacobiPerformance<<<lowerPyramidal.numSubdomains, 512, lowerPyramidal.sharedMemorySize>>>(topSweptSolution_d, bottomSweptSolution_d, iterationLevel_d, lowerPyramidal_d, numJacobiStepsMin, numJacobiSteps, numJacobiSteps);
		// cudaDeviceSynchronize();
		...
		stageAdvanceJacobiPerformance<<<dualBridge.numSubdomains, 512, dualBridge.sharedMemorySize>>>(topSweptSolution_d, bottomSweptSolution_d, iterationLevel_d, dualBridge_d, numJacobiStepsMin, numJacobiSteps, numJacobiSteps);
		// cudaDeviceSynchronize();
	...
	stageAdvanceJacobiPerformance<<<upperPyramidal.numSubdomains, 512, upperPyramidal.sharedMemorySize>>>(topSweptSolution_d, bottomSweptSolution_d, iterationLevel_d, upperPyramidal_d, numJacobiStepsMin, numJacobiSteps - numJacobiStepsIncrement, numJacobiSteps);
	// cudaDeviceSynchronize();
