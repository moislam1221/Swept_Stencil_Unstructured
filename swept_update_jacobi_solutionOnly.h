__global__
void stageAdvanceJacobiPerformanceSolutionOnlyMultiDOF(float * evenSolutionBuffer, float * oddSolutionBuffer, uint32_t * iterationLevels, meshPartitionForStageDevice partition, uint32_t numJacobiStepsMin, uint32_t numJacobiStepsMax, uint32_t maxIterShift = 0, bool finalStage = false)
{
...
__global__
void stageAdvanceJacobiPerformanceV2OverlapExperimentalSolutionOnlyMultiDOF(float * evenSolutionBufferOutput, float * oddSolutionBufferOutput, float * evenSolutionBuffer, float * oddSolutionBuffer, uint32_t * iterationLevels, uint32_t * iterationLevelsOutput, meshPartitionForStageDevice partition, uint32_t numJacobiStepsMin, uint32_t numJacobiStepsMax, uint32_t Ndofs, uint32_t maxIterShift = 0, bool finalStage = false)
{
	extern __shared__ float sharedMemorySolution[];
/*
...
__global__
void stageAdvanceJacobiPerformanceV2OverlapExperimentalSolutionOnly(float * evenSolutionBufferOutput, float * oddSolutionBufferOutput, float * evenSolutionBuffer, float * oddSolutionBuffer, uint32_t * iterationLevels, uint32_t * iterationLevelsOutput, meshPartitionForStageDevice partition, uint32_t numJacobiStepsMin, uint32_t numJacobiStepsMax, uint32_t Ndofs, uint32_t maxIterShift = 0, bool finalStage = false)
{
	extern __shared__ float sharedMemorySolution[];
/*
	// 0 - Copy contents from input buffers to output buffers
...
void determineSharedMemoryAllocationSolutionOnly(meshPartitionForStage &partition)
{
	...
	for (int i = 0; i < partition.numSubdomains; i++) {
		...
		sharedMemorySizeTemp = 2 * numDOFs * sizeof(float) + numDOFs * sizeof(int);
