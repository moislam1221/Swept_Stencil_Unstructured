...
int main (int argc, char * argv[]) 
{
	...
	uint32_t numIterations = numSweptCycles * 28;
	...
	uint32_t numJacobiIters = 14;
	
	// DIRECTORY CONTAINING PARTITION AND LEVEL INFORMATION
	std::string PARENT_DIRECTORY = "Unstructured_Mesh/Airfoil_Mesh_90k/Data_50_Subdomains/";
	...
	upperPyramidal.numSubdomains = 50; // 25
	...
	// determineSharedMemoryAllocationSolutionOnly(upperPyramidal);
	stageAdvanceJacobiPerformanceSolutionOnlyMultiDOF<<<upperPyramidal.numSubdomains, 512, upperPyramidal.sharedMemorySize>>>(evenSolutionBuffer_d, oddSolutionBuffer_d, iterationLevel_d, upperPyramidal_d, 0, numJacobiIters);
	//determineSharedMemoryAllocationSolutionOnly(upperPyramidal);
	...
	bridge.numSubdomains = 74; // 397; // 35
	...
	stageAdvanceJacobiPerformanceV2OverlapExperimentalSolutionOnlyMultiDOF<<<bridge.numSubdomains, 512, bridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d,  iterationLevel_d, iterationLevelOutput_d, bridge_d, 0, numJacobiIters, Ndofs);
	...
	lowerPyramidal.numSubdomains = 66; // 309; // 22;
	...
	stageAdvanceJacobiPerformanceSolutionOnlyMultiDOF<<<lowerPyramidal.numSubdomains, 512, lowerPyramidal.sharedMemorySize>>>(evenSolutionBuffer_d, oddSolutionBuffer_d, iterationLevel_d, lowerPyramidal_d, 0, numJacobiIters); 
	// V2 kernel (overlapping)
	...
	dualBridge.numSubdomains = 74; // 397; // 35;
	...
	stageAdvanceJacobiPerformanceV2OverlapExperimentalSolutionOnlyMultiDOF<<<dualBridge.numSubdomains, 512, dualBridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d,  iterationLevel_d, iterationLevelOutput_d, dualBridge_d, 0, 2*numJacobiIters, Ndofs);
	tmp = evenSolutionBuffer_d; evenSolutionBuffer_d = evenSolutionBufferOutput_d; evenSolutionBufferOutput_d = tmp;
	tmp = oddSolutionBuffer_d; oddSolutionBuffer_d = oddSolutionBufferOutput_d; oddSolutionBufferOutput_d = tmp;
	tmpInt = iterationLevel_d; iterationLevel_d = iterationLevelOutput_d; iterationLevelOutput_d = tmpInt;
	...
	for (int sweptIteration = 0; sweptIteration < numSweptCycles; sweptIteration++) {
		...
		// V1 kernel (non-overlapping)
		stageAdvanceJacobiPerformanceSolutionOnlyMultiDOF<<<upperPyramidal.numSubdomains, 512, upperPyramidal.sharedMemorySize>>>(evenSolutionBuffer_d, oddSolutionBuffer_d, iterationLevel_d, upperPyramidal_d, minJacobiIters, maxJacobiIters, maxJacobiShift);
		...
		stageAdvanceJacobiPerformanceV2OverlapExperimentalSolutionOnlyMultiDOF<<<bridge.numSubdomains, 512, bridge.sharedMemorySize>>>(evenSolutionBufferOutput_d, oddSolutionBufferOutput_d, evenSolutionBuffer_d, oddSolutionBuffer_d,  iterationLevel_d, iterationLevelOutput_d, bridge_d, minJacobiIters, maxJacobiIters, Ndofs, maxJacobiShift);
		tmp = evenSolutionBuffer_d; evenSolutionBuffer_d = evenSolutionBufferOutput_d; evenSolutionBufferOutput_d = tmp;
		tmp = oddSolutionBuffer_d; oddSolutionBuffer_d = oddSolutionBufferOutput_d; oddSolutionBufferOutput_d = tmp;
		tmpInt = iterationLevel_d; iterationLevel_d = iterationLevelOutput_d; iterationLevelOutput_d = tmpInt;
		//
		...
		stageAdvanceJacobiPerformanceSolutionOnlyMultiDOF<<<lowerPyramidal.numSubdomains, 512, lowerPyramidal.sharedMemorySize>>>(evenSolutionBuffer_d, oddSolutionBuffer_d, iterationLevel_d, lowerPyramidal_d, minJacobiIters, maxJacobiIters, maxJacobiShift);
		// V2 kernel (overlapping)
	...
	// V1 kernel (non-overlapping)
	stageAdvanceJacobiPerformanceSolutionOnlyMultiDOF<<<upperPyramidal.numSubdomains, 512, upperPyramidal.sharedMemorySize>>>(evenSolutionBuffer_d, oddSolutionBuffer_d, iterationLevel_d, upperPyramidal_d, minJacobiIters, maxJacobiIters, maxJacobiShift, finalStage);
	//
